...
/**
 * PerformanceLoadingStates.jsx
 * Skeleton placeholders and spinners for EWMP Performance Management module.
 */
      ...
      {Array.from({ length: rows }).map((_, i) => (
        <div key={i} className="p-4 flex items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 bg-[#ededf9] dark:bg-gray-800 rounded-lg shrink-0"></div>
...
export const ProfileLoader = () => (
  <div className="bg-[#ffffff] dark:bg-[#111111] border border-[#e1e2ed] dark:border-gray-800 rounded-lg p-6 space-y-6 animate-pulse">
    <div className="flex items-center gap-4">
      <div className="w-16 h-16 bg-[#ededf9] dark:bg-gray-800 rounded-xl"></div>
      <div className="space-y-2">
        <div className="w-48 h-6 bg-[#ededf9] dark:bg-gray-800 rounded"></div>
        <div className="w-32 h-4 bg-[#ededf9] dark:bg-gray-800 rounded"></div>
      </div>
    </div>
    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
      <div className="h-20 bg-[#ededf9] dark:bg-gray-800 rounded-lg"></div>
      <div className="h-20 bg-[#ededf9] dark:bg-gray-800 rounded-lg"></div>
      <div className="h-20 bg-[#ededf9] dark:bg-gray-800 rounded-lg"></div>
    </div>
  </div>
